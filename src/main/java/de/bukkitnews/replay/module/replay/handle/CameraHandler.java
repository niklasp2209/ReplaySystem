...
public class CameraHandler {
    ...
    public CameraHandler(CameraObject cameraObject) {
     ...
     */
    public Optional<RecordingArea> getCreatedCamera(Player player) {
     ...
     */
    public Optional<RecordingArea> findById(String id) {
     ...
     */
    public List<RecordingArea> getCamerasForPlayer(Player player) {
